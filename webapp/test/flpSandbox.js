			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"VisaTask-display": {
								"semanticObject": "VisaTask",
								"action": "display",
								"description": "Visa task",
								"title": "VisaTask",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=home.kpmg.VisaTask",
									"url": sap.ui.require.toUrl("home/kpmg/VisaTask")
								}
							}
						}
					}
